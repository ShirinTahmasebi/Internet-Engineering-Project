 ...
 * Generated at: 2016-05-13 22:41:30 UTC
...
return;
    ...
    try {
      ...
      out.write("    \t\t\n");
      out.write("                            <form class=\"form\" id=\"form1\"  role=\"form\" method=\"post\" action=\"LoginController\">\n");
      out.write("      \t\t\t<p class=\"name\" >\n");
      out.write("        \t\t\t<input name=\"name\" type=\"text\" class=\"validate[required,custom[onlyLetter],length[0,100]] feedback-input\" placeholder=\"نام کاربری\" id=\"name\" />\n");
      out.write("      \t\t\t</p>\n");
      out.write("      \n");
      ...
      out.write("        \t\t\t\t\t<input type=\"submit\" value=\"ورود\" id=\"button-red\"/>\n");
      out.write("      \t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("      \n");
      out.write("    \t\t</form>\n");
      out.write("    \t\t<br>\n");
      out.write("    \t\t<p>اگر حساب کاربری ندارید، برای ثبت نام <a href=\"register.html\">اینجا</a> را کلیک کنید.</p>\n");
      out.write("\n");
      out.write("  \t\t\t</div>\n");
      out.write("  \t\t</div>\n");
      out.write("    \n");
