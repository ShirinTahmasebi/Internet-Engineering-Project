...
%>
	...
	<body style="margin:20px auto" class= "table-body">
		<div class="container" >
	...
	<script type="text/javascript">$(document).ready(function (){var table = $("#myTable").DataTable({"language": {"url": "https://cdn.datatables.net/plug-ins/1.10.7/i18n/Persian.json"}});$("#myTable").on( "click", "tbody tr", function () {window.location.href = "project_details.jsp";} );}); </script>
	</body>
</html>